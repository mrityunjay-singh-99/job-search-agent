...
class InterviewAgent:
    ...
    def generate_basic_questions(self, job_data, resume_data = None, question_count=10):
        ...
        question_count(init): Number of querstions to generate.
        ...
        try:
            ...
            llm = ChatGoogleGenerativeAI(model=self.model,api_key=self.api_key,temperature=0.7)
            ...
            2.Context fot why this question matters
            ...
            {{
                ...
                "context": "Why this question is asking and what it's testing"
                "tips": "How to approch answering this question"
            ...
            response = chain.invoke({
                ...
                "interview_customization": interview_customization,
        ...
        def _generate_basic_questions(self, job_data, question_count=10):
            """Generate basic interview questions when GeminiAI is not available."""
